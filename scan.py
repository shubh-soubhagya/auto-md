...
#     root_directory = r"C:\Users\hp\Desktop\Accen\StudTool"  # You can replace this with your target directory
...
def scan_files(root_dir, extensions=(".py", ".ipynb", ".env", ".html", ".css", ".js")):
    file_data = []
...
if __name__ == "__main__":
    root_directory = r"C:\Users\hp\Desktop\Accen\StudTool"  # Change to your directory path
    scanned_data = scan_files(root_directory)
    save_to_csv(scanned_data)
    print(f"✅ Saved {len(scanned_data)} files to 'scanned_files.csv'")
